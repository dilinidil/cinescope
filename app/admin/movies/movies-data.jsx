...
export default async function MoviesData({ query = "" }) {
  ...
  // Option 1: Fetch movies from /api/movies - Tried on home page, works fine
  ...
  try {
    ...
    //return <div>Movies Available!</div>;
    return <MovieTable movies={refinedMovies}/>; //pass as a property
  } catch (error) {
