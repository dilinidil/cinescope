...
export default async function AdminDashboard() {
  ...
  //console.log(movies);
  //console.log(movies.map(m => m._id));
  //const filter = movies.filter((movie) => movie.id === undefined);
  //console.log(filter.length);
  const moviesFiltered = movies.filter((movie) => movie.year === 2011);
        ...
        <TabsContent value="recent-movies" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-4">
            {movies.slice(0, 6).map((movie) => (
              <Card key={ movie._id } className="overflow-hidden py-0">
